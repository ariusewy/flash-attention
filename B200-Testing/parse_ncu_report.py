...
CALIB_METRICS = {
    ...
    "smsp__sass_thread_inst_executed_op_fp32_pred_on":                 "fp32_thread_inst",
    "smsp__sass_thread_inst_executed_op_fadd_pred_on":                 "fadd_thread_inst",
    "smsp__sass_thread_inst_executed_op_fmul_pred_on":                 "fmul_thread_inst",
    "smsp__sass_thread_inst_executed_op_ffma_pred_on":                 "ffma_thread_inst",
    "smsp__sass_thread_inst_executed_ops_fadd_fmul_ffma_pred_on":      "fadd_fmul_ffma_thread_inst",
    "smsp__sass_thread_inst_executed_op_conversion_pred_on":           "conversion_thread_inst",
    "smsp__sass_thread_inst_executed_op_misc_pred_on":                 "misc_thread_inst",
    "smsp__sass_thread_inst_executed_op_inter_thread_communication_pred_on": "inter_thread_comm_inst",
    # Blackwell TMEM / UTC instruction mix
    "smsp__sass_inst_executed_op_tmem":                                "tmem_inst",
    "smsp__sass_inst_executed_op_tmem_ldt":                            "tmem_ld_inst",
    "smsp__sass_inst_executed_op_tmem_stt":                            "tmem_st_inst",
    "smsp__sass_inst_executed_op_utccp":                               "utccp_inst",
    "smsp__sass_inst_executed_op_utcmma":                              "utcmma_inst",
    # Warp / occupancy
