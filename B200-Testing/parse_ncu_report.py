...
CALIB_METRICS = {
    ...
    # Softmax-adjacent scalar/math instruction mix (counter .sum suffix required)
    "smsp__sass_thread_inst_executed_op_fp32_pred_on.sum":                 "fp32_thread_inst",
    "smsp__sass_thread_inst_executed_op_fadd_pred_on.sum":                 "fadd_thread_inst",
    "smsp__sass_thread_inst_executed_op_fmul_pred_on.sum":                 "fmul_thread_inst",
    "smsp__sass_thread_inst_executed_op_ffma_pred_on.sum":                 "ffma_thread_inst",
    "smsp__sass_thread_inst_executed_ops_fadd_fmul_ffma_pred_on.sum":      "fadd_fmul_ffma_thread_inst",
    "smsp__sass_thread_inst_executed_op_conversion_pred_on.sum":           "conversion_thread_inst",
    "smsp__sass_thread_inst_executed_op_misc_pred_on.sum":                 "misc_thread_inst",
    "smsp__sass_thread_inst_executed_op_inter_thread_communication_pred_on.sum": "inter_thread_comm_inst",
    # B200 SM100 TMEM / UTC instruction mix (not in GB10 NCU catalog; keep for B200)
    "smsp__sass_inst_executed_op_tmem.sum":                                "tmem_inst",
    "smsp__sass_inst_executed_op_tmem_ldt.sum":                            "tmem_ld_inst",
    "smsp__sass_inst_executed_op_tmem_stt.sum":                            "tmem_st_inst",
    "smsp__sass_inst_executed_op_utccp.sum":                               "utccp_inst",
    "smsp__sass_inst_executed_op_utcmma.sum":                              "utcmma_inst",
    # Warp / occupancy
...
CSV_COLS = [
    ...
    "fmul_thread_inst",
    "ffma_thread_inst",
    "fadd_fmul_ffma_thread_inst",
    "conversion_thread_inst",
    "misc_thread_inst",
    "inter_thread_comm_inst",
    "tmem_inst",
    "tmem_ld_inst",
    "tmem_st_inst",
    "utccp_inst",
