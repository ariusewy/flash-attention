...
def _flash_attn_fwd(
    ...
    # cutez tracing is implemented only by the generic SM100/SM110 forward class.
    # In particular, do not pass its extra arguments to MLA or the dedicated hd256 class.
    trace_enabled = (
        _CUTEZ_TRACE_ENABLED
    ...
    compile_key = (
        ...
        trace_enabled,  # cutez.trace: separate cache entry for trace-enabled path
    )
    ...
    if compile_key not in _flash_attn_fwd.compile_cache:
        ...
        if arch // 10 == 8:
            ...
            if qv is not None:
                ...
                if not use_dedicated_hd256_kernel:
                    ...
                    fa_fwd_kwargs["trace_cfg"] = _CUTEZ_TRACE_CFG if trace_enabled else None
        ...
        if qv is not None:
            ...
            if arch // 10 in [10, 11] and not use_dedicated_hd256_kernel:
                ...
                # Generic SM100/SM110 forward accepts trace_out immediately before stream.
                # The dedicated hd256 class has a different signature and is intentionally excluded.
    ...
    if not fake_mode:
        ...
        if qv is not None:
            ...
            if arch // 10 in [10, 11] and not use_dedicated_hd256_kernel:
                ...
                if trace_enabled and _CUTEZ_TRACE_SESSION is not None:
